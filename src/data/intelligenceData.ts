...
export const intelligenceChapters: Chapter[] = [
  {
    id: "int-1",
...
export const intelligenceExperienceMCQs: MCQ[] = [
  ...
  { id: 6, question: "Why do we boil milk?", options: ["To make it sweet", "To kill germs", "To change color", "To make it thick"], correctAnswer: 1, isExperienceBased: true },
  { id: 7, question: "Odd one out: Monkey, Baboon, Ape, Chimpanzee, Panda", options: ["Monkey", "Baboon", "Chimpanzee", "Panda"], correctAnswer: 3, isExperienceBased: true },
  { id: 8, question: "90% of 90 equals?", options: ["81", "72", "85", "90"], correctAnswer: 0, isExperienceBased: true },
  { id: 9, question: "A person moves north, then south and back, turns left. His direction?", options: ["East", "West", "North", "South"], correctAnswer: 1, isExperienceBased: true },
  { id: 10, question: "A person walks 10 miles north, turns left then right. His direction?", options: ["East", "West", "North", "South"], correctAnswer: 2, isExperienceBased: true },
  { id: 11, question: "A man moves north, turns left, turns left again. His direction?", options: ["East", "West", "North", "South"], correctAnswer: 3, isExperienceBased: true },
  { id: 12, question: "Train speed is double that of car. Car travels 30km in 1 hour. Distance train covers in 30 minutes?", options: ["20 km", "25 km", "30 km", "35 km"], correctAnswer: 2, isExperienceBased: true },
  { id: 13, question: "Train moving at 90 km/h. Distance covered in 12 minutes?", options: ["15 km", "18 km", "20 km", "22 km"], correctAnswer: 1, isExperienceBased: true },
  { id: 14, question: "A man covers 20 km in 1 hour 40 minutes. Time to cover 1 km?", options: ["4 min", "5 min", "6 min", "8 min"], correctAnswer: 1, isExperienceBased: true },
  { id: 15, question: "43, 53, 63, ?", options: ["70", "73", "75", "83"], correctAnswer: 1, isExperienceBased: true },
  { id: 16, question: "Total weight of 5 soap boxes is 75 kg. Empty box is 5 kg. Weight of total soap?", options: ["45 kg", "50 kg", "55 kg", "60 kg"], correctAnswer: 1, isExperienceBased: true },
  { id: 17, question: "Odd one out: Pencil, Scale, Rubber, Line", options: ["Pencil", "Scale", "Rubber", "Line"], correctAnswer: 3, isExperienceBased: true },
  { id: 18, question: "A is B's son but C is not A's son. C is A's daughter. C to B?", options: ["Son", "Daughter", "Granddaughter", "Grandson"], correctAnswer: 2, isExperienceBased: true },
  { id: 19, question: "Research is to Scholars as Search is to?", options: ["Police", "Book", "Detective", "Library"], correctAnswer: 1, isExperienceBased: true },
  { id: 20, question: "Buy and sell at triple price. Profit percentage?", options: ["100%", "150%", "200%", "300%"], correctAnswer: 2, isExperienceBased: true },
  { id: 21, question: "3 dozen eggs for 288, sold for 360. Profit percentage?", options: ["20%", "25%", "30%", "35%"], correctAnswer: 1, isExperienceBased: true },
  { id: 22, question: "1, 3, 7, 13, ?", options: ["19", "21", "23", "25"], correctAnswer: 1, isExperienceBased: true },
  { id: 23, question: "Odd one out: Uncle, Father, Mother, Sister", options: ["Uncle", "Father", "Mother", "Sister"], correctAnswer: 0, isExperienceBased: true },
  { id: 24, question: "2, 5, 11, 23, ?", options: ["35", "41", "47", "53"], correctAnswer: 2, isExperienceBased: true },
  { id: 25, question: "Complete: ABZ, CDY, ?", options: ["EFW", "EFX", "EGX", "FGX"], correctAnswer: 1, isExperienceBased: true },
  { id: 26, question: "5 × 10 = ?", options: ["50", "15", "500", "5"], correctAnswer: 0, isExperienceBased: true },
  { id: 27, question: "Oven is to?", options: ["Cold", "Heat", "Cook", "Bake"], correctAnswer: 1, isExperienceBased: true },
  { id: 28, question: "A is older than B, B older than C, C older than D. The oldest?", options: ["A", "B", "C", "D"], correctAnswer: 0, isExperienceBased: true },
  { id: 29, question: "Odd one out: Desk, Chair, Cardboard, Computer", options: ["Desk", "Chair", "Cardboard", "Computer"], correctAnswer: 2, isExperienceBased: true },
  { id: 30, question: "Odd one out: Monday, Friday, Tuesday, October", options: ["Monday", "Friday", "Tuesday", "October"], correctAnswer: 3, isExperienceBased: true },
  { id: 31, question: "Odd one out: Bread, Butter, Chocolate, Egg, Jam", options: ["Bread", "Butter", "Chocolate", "Egg"], correctAnswer: 2, isExperienceBased: true },
  { id: 32, question: "Odd one out: Football, Basketball, Tennis, Billiards", options: ["Football", "Basketball", "Tennis", "Billiards"], correctAnswer: 3, isExperienceBased: true },
  { id: 33, question: "Odd one out: 2, 4, 5, 50", options: ["2", "4", "5", "50"], correctAnswer: 2, isExperienceBased: true },
  { id: 34, question: "5, 10, 15, 20, ?, 30", options: ["22", "24", "25", "28"], correctAnswer: 2, isExperienceBased: true },
  { id: 35, question: "11, 22, 33, 44, ?", options: ["50", "55", "60", "66"], correctAnswer: 1, isExperienceBased: true },
  { id: 36, question: "A = 4, B = 3, then A² + B² = ?", options: ["20", "25", "30", "35"], correctAnswer: 1, isExperienceBased: true },
  { id: 37, question: "11, 7, 22, ? (Pattern: double first, then double second)", options: ["10", "12", "14", "16"], correctAnswer: 2, isExperienceBased: true },
  { id: 38, question: "If Friday dawned 3 days before yesterday, what day will be after tomorrow?", options: ["Friday", "Saturday", "Sunday", "Monday"], correctAnswer: 2, isExperienceBased: true },
  { id: 39, question: "Dog is to Bitch as Horse is to?", options: ["Stallion", "Mare", "Colt", "Pony"], correctAnswer: 1, isExperienceBased: true },
  { id: 40, question: "a, e, i, ?, o, u (Vowel sequence)", options: ["a", "e", "i", "u"], correctAnswer: 2, isExperienceBased: true },
  { id: 41, question: "A is father of B but B is not son of A. What is B to A?", options: ["Nephew", "Niece", "Daughter", "Grandson"], correctAnswer: 2, isExperienceBased: true },
  { id: 42, question: "Which country is north of Pakistan?", options: ["India", "China", "Afghanistan", "Iran"], correctAnswer: 1, isExperienceBased: true },
