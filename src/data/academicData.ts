      ...
      },
      {
        ...
        chapters: [
          { id: "new-ch1", name: "Physical Quantities and Measurements", importantTopics: ["Base & Derived Units", "Prefixes", "Scientific Notation", "Measuring Instruments", "Errors"], keyConcepts: ["SI Units", "Vernier Callipers", "Screw Gauge", "Significant Figures", "Precision & Accuracy"], formulas: ["Least Count of Vernier = 0.1 mm", "Least Count of Screw Gauge = 0.01 mm"], mcqs: [
            ...
            { id: "np9-ch1-3", question: "A light year is a unit of:", options: ["light", "time", "distance", "speed"], correctAnswer: 2, explanation: "A light year is the distance light travels in one year." , isExcluded: true },
            ...
            { id: "np9-ch1-6", question: "Volume of water consumed by you per day is estimated in:", options: ["millilitre", "litre", "kilogram", "cubic metre"], correctAnswer: 1, explanation: "Daily water consumption is typically measured in litres." , isExcluded: true },
            ...
            { id: "np9-ch1-8", question: "Two rods with lengths 12.321 cm and 10.3 cm are placed side by side, the difference in their lengths is:", options: ["2.02 cm", "2.0 cm", "2 cm", "2.021 cm"], correctAnswer: 1, explanation: "Following significant figures rules: 12.321 - 10.3 = 2.0 cm (1 decimal place)." , isExcluded: true },
          ...
          { id: "new-ch2", name: "Kinematics", importantTopics: ["Scalars & Vectors", "Types of Motion", "Speed & Velocity", "Acceleration", "Graphical Analysis", "Equations of Motion"], keyConcepts: ["Distance vs Displacement", "Uniform & Non-uniform Motion", "Free Fall"], formulas: ["v = u + at", "s = ut + ½at²", "v² = u² + 2as"], mcqs: [
            ...
            { id: "np9-ch2-5", question: "A body is moving with constant acceleration starting from rest. It covers a distance S in 4 seconds. How much time does it take to cover one-fourth of this distance?", options: ["1 s", "2 s", "4 s", "16 s"], correctAnswer: 1, explanation: "s ∝ t², so t = 4 × √(1/4) = 2 s" , isExcluded: true },
            { id: "np9-ch2-6", question: "The displacement time graphs of two objects A and B are shown in the figure. Point out the true statement from the following:", options: ["The velocity of A is greater than B", "The velocity of A is less than B", "The velocity of A is equal to that of B", "The graph gives no information in this regard"], correctAnswer: 0, explanation: "Steeper slope in displacement-time graph means greater velocity." , isExcluded: true },
            ...
            { id: "np9-ch2-8", question: "Gradient of the speed-time graph is equal to:", options: ["speed", "velocity", "acceleration", "distance covered"], correctAnswer: 2, explanation: "Slope of speed-time graph = rate of change of speed = acceleration." , isExcluded: true },
            { id: "np9-ch2-9", question: "Gradient of the distance-time graph is equal to the:", options: ["speed", "velocity", "distance covered", "acceleration"], correctAnswer: 0, explanation: "Slope of distance-time graph = distance/time = speed." , isExcluded: true },
            { id: "np9-ch2-10", question: "A car accelerates uniformly from 80.5 km/h at t = 0 to 113 km/h at t = 9 s. Which graph best describes the motion of the car?", options: ["Speed increasing linearly with time", "Speed constant with time", "Speed decreasing with time", "Speed increasing then decreasing"], correctAnswer: 0, explanation: "Uniform acceleration means speed increases linearly with time." , isExcluded: true }
          ] },
          { id: "new-ch3", name: "Dynamics", importantTopics: ["Newton's Laws", "Momentum", "Force", "Friction", "Impulse"], keyConcepts: ["Inertia", "Action-Reaction", "Conservation of Momentum", "Contact & Non-contact Forces"], formulas: ["F = ma", "p = mv", "Impulse = FΔt = Δp"], mcqs: [
            ...
            { id: "np9-ch3-4", question: "A ball with initial momentum p hits a solid wall and bounces back with the same velocity. Its momentum p' after collision will be:", options: ["p' = p", "p' = -p", "p' = 2p", "p' = -2p"], correctAnswer: 1, explanation: "Direction reverses with same magnitude, so momentum becomes -p." , isExcluded: true },
            ...
            { id: "np9-ch3-7", question: "An object with a mass of 5 kg moves at constant velocity of 10 m/s. A constant force then acts for 5 seconds on the object and gives it a velocity of 2 m/s in the opposite direction. The force acting on the object is:", options: ["5 N", "-10 N", "-12 N", "-15 N"], correctAnswer: 2, explanation: "F = m(v-u)/t = 5(-2-10)/5 = 5(-12)/5 = -12 N" , isExcluded: true },
            { id: "np9-ch3-8", question: "A large force acts on an object for a very short interval of time. In this case, it is easy to determine:", options: ["magnitude of force", "time interval", "product of force and time", "none of these"], correctAnswer: 2, explanation: "Impulse (F×t) is easier to determine than individual F or t for impulsive forces." , isExcluded: true },
          ...
          { id: "new-ch5", name: "Work, Energy and Power", importantTopics: ["Work", "Energy Types", "Power", "Energy Conservation"], keyConcepts: ["Kinetic Energy", "Potential Energy", "Work-Energy Theorem", "Renewable Energy"], formulas: ["W = Fd cos θ", "KE = ½mv²", "PE = mgh", "P = W/t"], mcqs: [
            ...
            { id: "np9-ch5-2", question: "A joule can also be written as:", options: ["kg m s⁻²", "kg m s⁻¹", "kg m² s⁻³", "kg m² s⁻²"], correctAnswer: 3, explanation: "1 J = 1 kg⋅m²⋅s⁻² (force × distance = kg⋅m⋅s⁻² × m)." , isExcluded: true },
            ...
            { id: "np9-ch5-4", question: "The power of a water pump is 2 kW. The amount of water it can raise in one minute to a height of 5 metres is:", options: ["1000 litres", "1200 litres", "2000 litres", "2400 litres"], correctAnswer: 3, explanation: "P = mgh/t, m = Pt/(gh) = 2000×60/(10×5) = 2400 kg = 2400 litres." , isExcluded: true },
            ...
            { id: "np9-ch5-7", question: "The energy possessed by a body by virtue of its position is:", options: ["kinetic energy", "potential energy", "chemical energy", "solar energy"], correctAnswer: 1, explanation: "Potential energy is the energy due to position or configuration." , isExcluded: true },
          ...
          { id: "new-ch7", name: "Thermal Properties of Matter", importantTopics: ["Temperature", "Thermometers", "Thermal Expansion", "Kinetic Molecular Theory"], keyConcepts: ["Celsius & Kelvin Scale", "Fahrenheit Scale", "Liquid-in-glass Thermometers", "Thermocouple"], formulas: ["K = °C + 273", "°F = (9/5)°C + 32"], mcqs: [
            { id: "np9-ch7-1", question: "How do the molecules in a solid behave?", options: ["Move randomly", "Vibrate about their mean positions", "Rotate and vibrate randomly at their own positions", "Move in a straight line from hot to cold ends"], correctAnswer: 1, explanation: "In solids, molecules vibrate about fixed mean positions." , isExcluded: true },
            { id: "np9-ch7-2", question: "What type of motion is of the molecules in a gas?", options: ["Linear motion", "Random motion", "Vibratory motion", "Rotatory motion"], correctAnswer: 1, explanation: "Gas molecules move in random directions with random speeds." , isExcluded: true },
            ...
            { id: "np9-ch7-7", question: "Which one is a better choice for a liquid-in-glass thermometer?", options: ["Is colourless", "Is a bad conductor", "Expand linearly", "Wets glass"], correctAnswer: 2, explanation: "A good thermometric liquid should expand linearly with temperature." , isExcluded: true },
            ...
            { id: "np9-ch7-10", question: "A thermometer has a narrow capillary tube so that it:", options: ["quickly responds to temperature changes", "can read the maximum temperature", "gives a large change for a given temperature rise", "can measure a large range of temperature"], correctAnswer: 2, explanation: "Narrow bore causes liquid to move more for same volume change, giving larger readings." , isExcluded: true },
            { id: "np9-ch7-11", question: "Which thermometer is most suitable for recording rapidly varying temperature?", options: ["Thermocouple thermometer", "Mercury-in-glass laboratory thermometer", "Alcohol-in-glass thermometer", "Mercury-in-glass clinical thermometer"], correctAnswer: 0, explanation: "Thermocouple has the fastest response time for rapidly changing temperatures." , isExcluded: true }
          ] },
          { id: "new-ch8", name: "Magnetism", importantTopics: ["Magnetic Materials", "Magnetic Field Lines", "Magnetization Methods", "Electromagnets"], keyConcepts: ["Permanent & Temporary Magnets", "Domain Theory", "Magnetic Shielding"], formulas: [], mcqs: [
            ...
            { id: "np9-ch8-3", question: "Permanent magnets cannot be made by:", options: ["soft iron", "steel", "neodymium", "alnico"], correctAnswer: 0, explanation: "Soft iron loses magnetism easily - used for temporary magnets, not permanent ones." , isExcluded: true },
            { id: "np9-ch8-4", question: "Permanent magnets are used in:", options: ["circuit breaker", "loudspeaker", "electric crane", "magnetic recording"], correctAnswer: 1, explanation: "Loudspeakers use permanent magnets to convert electrical signals to sound." , isExcluded: true },
          ...
          { id: "new-ch9", name: "Nature of Science", importantTopics: ["Branches of Physics", "Scientific Method", "Physics in Technology"], keyConcepts: ["Observation", "Hypothesis", "Experimentation", "Theory", "Law"], formulas: [], mcqs: [
            ...
            { id: "np9-ch9-4", question: "A user friendly software application of smart phone use:", options: ["laser technology", "information technology", "medical technology", "electronic technology"], correctAnswer: 1, explanation: "Smartphone apps are products of information technology." , isExcluded: true },
            { id: "np9-ch9-5", question: "The working of refrigeration and air conditioning involves:", options: ["electromagnetism", "mechanics", "climate science", "thermodynamics"], correctAnswer: 3, explanation: "Refrigeration and AC work on thermodynamic principles of heat transfer." , isExcluded: true },
            ...
            { id: "np9-ch9-7", question: "The statement 'If I do not study for this test, then I will not get good grade' is an example of:", options: ["theory", "observation", "prediction", "law"], correctAnswer: 2, explanation: "This is a prediction - an if-then statement about expected outcomes." , isExcluded: true },
            ...
            { id: "np9-ch9-11", question: "The colour of a door is brown. It is an example of:", options: ["observation", "hypothesis", "prediction", "law"], correctAnswer: 0, explanation: "Noting the colour of a door is a direct observation." , isExcluded: true }
          ] }
        ]
      },
      {
        ...
        chapters: [
          { id: "new-ch1", name: "States of Matter and Phase Changes", importantTopics: ["Chemistry Branches", "States of Matter", "Allotropy", "Solutions", "Solubility"], keyConcepts: ["Solid, Liquid, Gas, Plasma", "Elements, Compounds, Mixtures", "Saturated & Unsaturated Solutions"], formulas: [], mcqs: [
            { id: "nc9-ch1-1", question: "Matter is present in neon signs in the state of:", options: ["Supercritical fluid", "Plasma", "Gas", "Liquid crystal"], correctAnswer: 1, explanation: "Neon signs contain plasma - ionized gas that glows." , isExcluded: true },
            ...
            { id: "nc9-ch1-4", question: "The crystals of which substance has rhombic shape?", options: ["Brass", "Sulphur", "Graphite", "Bronze"], correctAnswer: 1, explanation: "Sulphur exists in rhombic crystalline allotropic form." , isExcluded: true },
            ...
            { id: "nc9-ch1-7", question: "A state of matter whose properties are between those of liquids and crystalline solids:", options: ["Liquid crystal", "Supercritical fluid", "Plasma", "Dark matter"], correctAnswer: 0, explanation: "Liquid crystals have properties intermediate between liquids and crystalline solids." , isExcluded: true },
          ...
          { id: "new-ch2", name: "Atomic Structure", importantTopics: ["Discharge Tube", "Subatomic Particles", "Bohr's Model", "Isotopes", "Radioactivity"], keyConcepts: ["Electron, Proton, Neutron", "Atomic Number", "Mass Number", "Shells & Energy Levels"], formulas: ["N = A - Z", "Max electrons in shell = 2n²"], mcqs: [
            ...
            { id: "nc9-ch2-7", question: "How is radiocarbon dating useful for archeologists?", options: ["It helps determine the age of organic matter", "It helps determine the composition of matter", "It helps determine the usefulness of matter", "It helps determine whether the matter is radioactive or not"], correctAnswer: 0, explanation: "Radiocarbon dating uses ¹⁴C decay to determine the age of organic remains." , isExcluded: true },
            ...
            { id: "nc9-ch2-10", question: "Rubidium consists of two isotopes ⁸⁵Rb and ⁸⁷Rb. The percent abundance of the light isotope is 72.2%. What is the percent abundance of the heavier isotope?", options: ["72%", "15%", "27.8%", "37%"], correctAnswer: 2, explanation: "100% - 72.2% = 27.8% for the heavier isotope." , isExcluded: true }
          ] },
      ...
      },
      {
        ...
        chapters: [
          ...
          { id: "new-ch2", name: "Logarithms", importantTopics: ["Scientific Notation", "Common & Natural Logarithm", "Laws of Logarithm", "Applications"], keyConcepts: ["Characteristic & Mantissa", "Product, Quotient, Power Laws", "Antilogarithm"], formulas: ["log(ab) = log a + log b", "log(a/b) = log a - log b", "log(aⁿ) = n log a"], mcqs: [
            ...
            { id: "nm9-ch2-4", question: "log₂ 2³ =", options: ["1", "2", "5", "3"], correctAnswer: 3, explanation: "log₂ 2³ = 3 log₂ 2 = 3 × 1 = 3." , isExcluded: true },
            ...
            { id: "nm9-ch2-9", question: "log 5 + log 3 =", options: ["log 0", "log 2", "log(5/3)", "log 15"], correctAnswer: 3, explanation: "By product law: log 5 + log 3 = log(5 × 3) = log 15." , isExcluded: true },
            { id: "nm9-ch2-10", question: "3⁴ = 81 in logarithmic form is:", options: ["log₃ 4 = 81", "log₄ 3 = 81", "log₃ 81 = 4", "log₄ 81 = 3"], correctAnswer: 2, explanation: "3⁴ = 81 converts to log₃ 81 = 4." , isExcluded: true }
          ] },
          { id: "new-ch3", name: "Set and Functions", importantTopics: ["Set Builder Form", "Power Set", "Venn Diagrams", "Cartesian Product", "Functions"], keyConcepts: ["Union, Intersection, Difference", "Complement", "Injective, Surjective, Bijective"], formulas: ["n(A∪B) = n(A) + n(B) - n(A∩B)", "|A×B| = |A| × |B|"], mcqs: [
            ...
            { id: "nm9-ch3-8", question: "If f(x) = x² − 3x + 2, then the value of f(a+1) is equal to:", options: ["a+1", "a²+1", "a²+2a+1", "a²−a"], correctAnswer: 3, explanation: "f(a+1) = (a+1)² − 3(a+1) + 2 = a²+2a+1 − 3a−3 + 2 = a²−a." , isExcluded: true },
            { id: "nm9-ch3-9", question: "Given that f(x) = 3x + 1, if f(x) = 28, then the value of x is:", options: ["9", "27", "3", "18"], correctAnswer: 0, explanation: "3x + 1 = 28 → 3x = 27 → x = 9." , isExcluded: true },
          ...
          { id: "new-ch4", name: "Factorization and Algebraic Manipulation", importantTopics: ["Common Factors", "Perfect Squares", "HCF & LCM", "Cube Factorization"], keyConcepts: ["Factor Theorem", "Difference/Sum of Cubes", "Square Root of Expression"], formulas: ["(a±b)³ = a³±3a²b+3ab²±b³", "a³−b³ = (a−b)(a²+ab+b²)", "LCM × HCF = Product"], mcqs: [
            ...
            { id: "nm9-ch4-6", question: "The square root of x² − 6x + 9 is:", options: ["±(x−3)", "±(x+3)", "x−3", "x+3"], correctAnswer: 0, explanation: "x² − 6x + 9 = (x−3)², so √ = ±(x−3)." , isExcluded: true },
          ...
          { id: "new-ch5", name: "Linear Equations and Inequalities", importantTopics: ["Linear Equations", "Linear Inequalities", "Graphing", "Feasible Region"], keyConcepts: ["Solution Set", "Associated Equation", "Half Planes", "Corner Point", "Objective Function"], formulas: [], mcqs: [
            ...
            { id: "nm9-ch5-7", question: "Corner point is also called:", options: ["code", "vertex", "curve", "region"], correctAnswer: 1, explanation: "A corner point of a feasible region is also called a vertex." , isExcluded: true },
            ...
            { id: "nm9-ch5-9", question: "The solution region restricted to the first quadrant is called:", options: ["objective region", "feasible region", "solution region", "constraints region"], correctAnswer: 1, explanation: "The feasible region is the solution region restricted to given constraints (usually first quadrant)." , isExcluded: true },
            { id: "nm9-ch5-10", question: "A function that is to be maximized or minimized is called:", options: ["solution function", "objective function", "feasible function", "none of these"], correctAnswer: 1, explanation: "In linear programming, the function to optimize is called the objective function." , isExcluded: true }
          ] },
          { id: "new-ch6", name: "Trigonometry", importantTopics: ["Radian & Degree Conversion", "Trigonometric Ratios", "Identities", "Heights & Distances"], keyConcepts: ["sin, cos, tan and reciprocals", "Pythagorean Identity", "Complementary Angles"], formulas: ["sin²θ + cos²θ = 1", "sec²θ − tan²θ = 1", "π rad = 180°"], mcqs: [
            ...
            { id: "nm9-ch6-3", question: "A person standing 50 m away from a building sees the top at angle of elevation 45°. Height of the building is:", options: ["50 m", "25 m", "35 m", "70 m"], correctAnswer: 0, explanation: "tan 45° = height/50 → height = 50 × 1 = 50 m." , isExcluded: true },
          ...
          { id: "new-ch8", name: "Logic", importantTopics: ["Inductive & Deductive Reasoning", "Logical Connectives", "Truth Tables", "Conditional & Contrapositive"], keyConcepts: ["Negation", "Conjunction", "Disjunction", "Conditional", "Biconditional", "Theorem vs Conjecture vs Axiom"], formulas: [], mcqs: [
            ...
            { id: "nm9-ch8-2", question: "Which of the following sentences describe deductive reasoning?", options: ["general conclusions from limited observations", "based on repeated experiments", "based on units of information that are accurate", "draw conclusion from well-known facts"], correctAnswer: 3, explanation: "Deductive reasoning draws conclusions from well-known, established facts." , isExcluded: true },
            { id: "nm9-ch8-3", question: "Which one of the following statements is true?", options: ["The set of integers is finite", "Sum of interior angles of any quadrilateral is always 180°", "22/7 ∉ Q'", "All isosceles triangles are equilateral triangles"], correctAnswer: 2, explanation: "22/7 is a rational number, so it does not belong to Q' (set of irrationals). This is true." , isExcluded: true },
            { id: "nm9-ch8-4", question: "Which statement best represents the negation of 'The stove is burning'?", options: ["the stove is not burning", "the stove is dim", "the stove is turned to low heat", "it is both burning and not burning"], correctAnswer: 0, explanation: "Negation simply reverses the truth value: 'The stove is not burning.'" , isExcluded: true },
            { id: "nm9-ch8-5", question: "The conjunction of two statements p and q is true when:", options: ["both p and q are false", "both p and q are true", "only q is true", "only p is true"], correctAnswer: 1, explanation: "p ∧ q is true only when both p and q are true." , isExcluded: true },
            { id: "nm9-ch8-6", question: "A conditional is regarded as false only when:", options: ["antecedent is true and consequent is false", "consequent is true and antecedent is false", "antecedent is true only", "consequent is false only"], correctAnswer: 0, explanation: "p → q is false only when p is true and q is false." , isExcluded: true },
            { id: "nm9-ch8-7", question: "Contrapositive of q → p is:", options: ["q → ~p", "~q → p", "~p → ~q", "~q → ~p"], correctAnswer: 2, explanation: "Contrapositive of q → p is ~p → ~q." , isExcluded: true },
            { id: "nm9-ch8-8", question: "The statement 'Every integer greater than 2 is a sum of two prime numbers' is:", options: ["theorem", "conjecture", "axiom", "postulate"], correctAnswer: 1, explanation: "This is Goldbach's conjecture — unproven but widely believed to be true." , isExcluded: true },
            { id: "nm9-ch8-9", question: "The statement 'A straight line can be drawn between any two points' is:", options: ["theorem", "conjecture", "axiom", "logic"], correctAnswer: 2, explanation: "This is Euclid's first postulate/axiom — accepted without proof." , isExcluded: true },
            { id: "nm9-ch8-10", question: "The statement 'The sum of the interior angles of a triangle is 180°' is:", options: ["converse", "theorem", "axiom", "conditional"], correctAnswer: 1, explanation: "This is a proven theorem in Euclidean geometry." , isExcluded: true }
          ] },
          { id: "new-ch9", name: "Similar Figures", importantTopics: ["Similar Polygons", "Area & Volume Ratios", "Regular Polygons", "Diagonals"], keyConcepts: ["Corresponding Sides Ratio", "Area ∝ (side)²", "Volume ∝ (side)³", "Exterior Angle = 360°/n"], formulas: ["Diagonals = n(n−3)/2", "Interior angle = (n−2)×180°/n", "Exterior angle = 360°/n"], mcqs: [
            ...
            { id: "nm9-ch9-4", question: "The exterior angle of a regular pentagon is:", options: ["40°", "45°", "60°", "72°"], correctAnswer: 3, explanation: "Exterior angle = 360°/5 = 72°." , isExcluded: true },
            ...
            { id: "nm9-ch9-6", question: "The total number of diagonals in a polygon with 9 sides is:", options: ["18", "21", "25", "27"], correctAnswer: 3, explanation: "Diagonals = n(n−3)/2 = 9(9−3)/2 = 9×6/2 = 27." , isExcluded: true },
            { id: "nm9-ch9-7", question: "Two spheres are similar with radii ratio 4:5. If surface area of larger sphere is 500π cm², the surface area of the smaller is:", options: ["256π cm²", "320π cm²", "400π cm²", "405π cm²"], correctAnswer: 1, explanation: "Surface area ratio = (4/5)² = 16/25. Smaller SA = 500π × 16/25 = 320π cm²." , isExcluded: true },
            { id: "nm9-ch9-8", question: "A regular polygon has an exterior angle of 30°. How many diagonals does it have?", options: ["54", "90", "72", "108"], correctAnswer: 0, explanation: "n = 360/30 = 12 sides. Diagonals = 12(12−3)/2 = 12×9/2 = 54." , isExcluded: true },
            { id: "nm9-ch9-9", question: "In a regular hexagon, the ratio of the length of a diagonal to the side length is:", options: ["√3 : 1", "2 : 1", "3 : 2", "2 : 3"], correctAnswer: 0, explanation: "The shorter diagonal of a regular hexagon = side × √3, so ratio is √3 : 1." , isExcluded: true },
            { id: "nm9-ch9-10", question: "A regular polygon has an interior angle of 165°. How many sides does it have?", options: ["15", "16", "20", "24"], correctAnswer: 3, explanation: "Exterior angle = 180° − 165° = 15°. n = 360/15 = 24 sides." , isExcluded: true }
          ] },
          ...
          { id: "new-ch11", name: "Loci and Construction", importantTopics: ["Triangle Construction", "Locus Definitions", "Angle & Perpendicular Bisectors"], keyConcepts: ["Median", "Circumcircle", "Incircle", "Locus from Point/Line"], formulas: [], mcqs: [
            ...
            { id: "nm9-ch11-10", question: "The set of all points farther than 2 km from a fixed point B is a region outside a circle of radius ______ and centre at B.", options: ["1 km", "1.9 km", "2 km", "2.1 km"], correctAnswer: 2, explanation: "Points farther than 2 km from B lie outside a circle of radius 2 km centered at B." , isExcluded: true }
          ] },
          ...
          { id: "new-ch13", name: "Probability", importantTopics: ["Sample Space", "Events", "Relative Frequency", "Expected Frequency"], keyConcepts: ["Sample Point", "Favourable Outcome", "Equally Likely Events", "Probability Formula"], formulas: ["P(E) = n(E)/n(S)", "Expected Freq = P(E) × n"], mcqs: [
            ...
            { id: "nm9-ch13-5", question: "The sum of all expected frequencies is equal to the fixed number of:", options: ["trials", "relative frequencies", "outcomes", "events"], correctAnswer: 0, explanation: "Sum of all expected frequencies equals the total number of trials." , isExcluded: true },
