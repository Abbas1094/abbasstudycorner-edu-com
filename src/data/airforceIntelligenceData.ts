...
export const afNvQuestionRanges: Record<string, { start: number; end: number }> = {
  ...
  "af-nv-2": { start: 8, end: 17 },
  "af-nv-3": { start: 18, end: 33 },
  "af-nv-4": { start: 34, end: 42 },
  "af-nv-5": { start: 43, end: 50 },
};

export const airforceNonVerbalChapters: Chapter[] = [
  { id: "af-nv-1", name: "Figure Analogies", description: "Shape relationship & transformation (Q1-Q7)", icon: "🔀", mcqs: allPafNonVerbalMCQs.slice(0, 7) },
  { id: "af-nv-2", name: "Matrix Completion", description: "Find the missing pattern in 3×3 grids (Q8-Q17)", icon: "🔲", mcqs: allPafNonVerbalMCQs.slice(7, 17) },
...
export const nonVerbalPatternMCQs: MCQ[] = [
  ...
  { id: 1, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_1.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "The pattern inverts: empty circle in quadrant becomes filled black square" },
  // Page 2: Triangle with shapes analogy
  { id: 2, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_2.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Shape transformation with fill pattern maintained" },
  // Page 3: Four shapes analogy with cross and circle patterns
  { id: 3, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_3.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 3, explanation: "Cross and dotted circle pattern transformation" },
  // Page 4: Arrow direction patterns
  { id: 4, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_4.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 3, explanation: "Arrow direction follows alternating pattern" },
  // Page 5: Dots with triangle analogy
  { id: 5, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_5.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Triangle inverts with corresponding dot pattern" },
  // Page 6: Nested squares with arrows
  { id: 6, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_6.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 2, explanation: "Arrow rotation pattern in nested squares" },
  // Page 7: Grid with stripe patterns
  { id: 7, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_7.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Stripe pattern follows inversion rule" },
  // Page 8: Matrix completion - shapes with lines
  { id: 8, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_8.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 3, explanation: "X pattern with curved lines follows sequence" },
  // Page 9: Matrix - flower/cross patterns
  { id: 9, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_9.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 2, explanation: "Flower pattern rotates and transforms" },
  // Page 10: Matrix - oval with lines
  { id: 10, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_10.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 0, explanation: "Line position rotates clockwise in each row" },
  // Page 11: Matrix - shapes with 1/2 fractions
  { id: 11, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_11.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 2, explanation: "Shape transforms across columns maintaining fraction" },
  // Page 12: Matrix - ovals with dots
  { id: 12, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_12.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 3, explanation: "Dot moves and shape transforms progressively" },
  // Page 13: Matrix - triangle patterns
  { id: 13, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_13.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 1, explanation: "Triangle orientation follows row pattern" },
  // Page 14: Matrix - curves and flowers
  { id: 14, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_14.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 0, explanation: "Petal and curve pattern sequence" },
  // Page 15: Matrix - complex patterns
  { id: 15, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_15.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 0, explanation: "Combined shape pattern follows rule" },
  // Page 16: Matrix - crossed lines with arrows
  { id: 16, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_16.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 2, explanation: "Arrow cross pattern with line transformation" },
  // Page 17: Matrix - circles with lines
  { id: 17, question: "Matrix Completion: Find the missing pattern", questionImage: "/nonverbal/page_17.webp", options: ["Option 1", "Option 2", "Option 3", "Option 4"], correctAnswer: 0, explanation: "Circle with extending lines pattern" },
  // Page 18: Analogy with plus signs in circle
  { id: 18, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_18.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 3, explanation: "Plus signs in divided circle follow transformation" },
  // Page 19: Pie chart analogy
  { id: 19, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_19.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 3, explanation: "Pie slice position and shading pattern" },
  // Page 20: Triangle with circle analogy
  { id: 20, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_20.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 3, explanation: "Circle position relative to triangle" },
  // Page 21: H-shape analogy
  { id: 21, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_21.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "H-shape with shading pattern" },
  // Page 22: Rectangle blocks analogy
  { id: 22, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_22.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Block shading position transformation" },
  // Page 23: Step pattern analogy
  { id: 23, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_23.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 2, explanation: "Step pattern with circle position" },
  // Page 24: Face-like circles analogy
  { id: 24, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_24.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 2, explanation: "Circle arrangement follows pattern" },
  // Page 25: Quarter circle pattern analogy
  { id: 25, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_25.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Quarter circle with internal patterns" },
  // Page 26: 3D shape analogy
  { id: 26, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_26.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 3, explanation: "3D shape transformation pattern" },
  // Page 27: Oval with dots analogy
  { id: 27, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_27.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Dot arrangement in oval follows pattern" },
  // Page 28: Square with dots analogy
  { id: 28, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_28.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Filled dot pattern transformation" },
  // Page 29: Triangle with nodes analogy
  { id: 29, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_29.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 2, explanation: "Node coloring pattern on shapes" },
  // Page 30: Pentagon analogy
  { id: 30, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_30.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 2, explanation: "Shape expansion with diamond" },
  // Page 31: Circle with spiral analogy
  { id: 31, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_31.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Spiral transforms to target pattern" },
  // Page 32: Mixed symbols analogy
  { id: 32, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_32.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 1, explanation: "Symbol sequence transformation" },
  // Page 33: Oval chain analogy
  { id: 33, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_33.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Oval chain shape transformation" },
  // Page 34: Brick pattern completion
  { id: 34, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_34.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 3, explanation: "Brick pattern alignment" },
  // Page 35-50: Additional pattern questions
  { id: 35, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_35.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Grid pattern follows sequence" },
  { id: 36, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_36.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Shape arrangement pattern" },
  { id: 37, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_37.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Complex grid pattern" },
  { id: 38, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_38.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Shape transformation sequence" },
  { id: 39, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_39.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Geometric pattern" },
  { id: 40, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_40.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Visual pattern completion" },
  { id: 41, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_41.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Shape matching pattern" },
  { id: 42, question: "Pattern Completion: Find the missing piece", questionImage: "/nonverbal/page_42.webp", options: ["Option a", "Option b", "Option c", "Option d"], correctAnswer: 0, explanation: "Grid completion pattern" },
  { id: 43, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_43.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Shape analogy pattern" },
  { id: 44, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_44.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Complex symbol pattern" },
  { id: 45, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_45.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Multi-shape analogy" },
  { id: 46, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_46.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Triangle transformation" },
  { id: 47, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_47.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Shape series pattern" },
  { id: 48, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_48.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Cross symbol pattern" },
  { id: 49, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_49.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Final analogy pattern" },
  { id: 50, question: "Non-Verbal Analogy: Study the pattern and select the correct option", questionImage: "/nonverbal/page_50.webp", options: ["Option A", "Option B", "Option C", "Option D"], correctAnswer: 0, explanation: "Letter code pattern" }
];
